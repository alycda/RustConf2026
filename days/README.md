...
| [2015-12-01](2015-12-01/) | Not Quite Lisp | char stream → `i32`; part 2 returns a position, not a total | Rust reference + every FFI variant, including wasm both ways (raw and wasm-bindgen + Effect — Exercise 4's reference) |
