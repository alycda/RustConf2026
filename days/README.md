...
| [2015-12-01](2015-12-01/) | Not Quite Lisp | char stream → `i32`; part 2 returns a position, not a total | Rust reference + libtcc + libcaca + cbindgen C API + Python, Fortran, R and Godot tracks, and wasm both ways (raw and wasm-bindgen + Effect — Exercise 4's reference) |
...
`2023-12-01`, `2024-12-01` and `2024-12-03` so far; nothing in the workshop needs one,
and not every day has them.
