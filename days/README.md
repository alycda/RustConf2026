...
| [2015-12-01](2015-12-01/) | Not Quite Lisp | char stream → `i32`; part 2 returns a position, not a total | Rust reference + libtcc + libcaca + cbindgen C API + Python and Fortran tracks |
